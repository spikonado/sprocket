...
After **Build and Test** succeeds for a commit on `main`, the npm workflow automatically publishes a development release as `0.3.8-dev.<full-commit-sha>` with the npm `dev` dist-tag.
