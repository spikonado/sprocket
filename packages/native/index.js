...
function requireNative() {
	if (process.env.NAPI_RS_NATIVE_LIBRARY_PATH) {
		...
		if (process.arch === 'arm64') {
			...
			try {
				const binding = require('@sprocket/native-android-arm64');
			...
			try {
				const binding = require('@sprocket/native-android-arm-eabi');
				const bindingPackageVersion =
		...
		if (process.arch === 'x64') {
			if (
				...
				try {
					const binding = require('@sprocket/native-win32-x64-gnu');
					const bindingPackageVersion =
				...
				try {
					const binding = require('@sprocket/native-win32-x64-msvc');
					const bindingPackageVersion =
			...
			try {
				const binding = require('@sprocket/native-win32-ia32-msvc');
				const bindingPackageVersion =
			...
			try {
				const binding = require('@sprocket/native-win32-arm64-msvc');
				const bindingPackageVersion =
		...
		try {
			const binding = require('@sprocket/native-darwin-universal');
			const bindingPackageVersion =
		...
		if (process.arch === 'x64') {
			...
			try {
				const binding = require('@sprocket/native-freebsd-arm64');
				const bindingPackageVersion =
		...
		if (process.arch === 'x64') {
			if (isMusl()) {
				...
				try {
					const binding = require('@sprocket/native-linux-x64-musl');
					const bindingPackageVersion =
				...
				try {
					const binding = require('@sprocket/native-linux-x64-gnu');
					const bindingPackageVersion =
			...
			if (isMusl()) {
				...
				try {
					const binding = require('@sprocket/native-linux-arm64-musl');
					const bindingPackageVersion =
				...
				try {
					const binding = require('@sprocket/native-linux-arm64-gnu');
					const bindingPackageVersion =
			...
			if (isMusl()) {
				...
				try {
					const binding = require('@sprocket/native-linux-arm-musleabihf');
					const bindingPackageVersion =
				...
				try {
					const binding = require('@sprocket/native-linux-arm-gnueabihf');
					const bindingPackageVersion =
			...
			if (isMusl()) {
				...
				try {
					const binding = require('@sprocket/native-linux-loong64-musl');
					const bindingPackageVersion =
				...
				try {
					const binding = require('@sprocket/native-linux-loong64-gnu');
					const bindingPackageVersion =
			...
			if (isMusl()) {
				...
				try {
					const binding = require('@sprocket/native-linux-riscv64-musl');
					const bindingPackageVersion =
				...
				try {
					const binding = require('@sprocket/native-linux-riscv64-gnu');
					const bindingPackageVersion =
			...
			try {
				const binding = require('@sprocket/native-linux-ppc64-gnu');
				const bindingPackageVersion =
			...
			try {
				const binding = require('@sprocket/native-linux-s390x-gnu');
				const bindingPackageVersion =
		...
		if (process.arch === 'arm64') {
			...
			try {
				const binding = require('@sprocket/native-openharmony-arm64');
				const bindingPackageVersion =
			...
			try {
				const binding = require('@sprocket/native-openharmony-x64');
				const bindingPackageVersion =
			...
			try {
				const binding = require('@sprocket/native-openharmony-arm');
				const bindingPackageVersion =
...
if (!nativeBinding || process.env.NAPI_RS_FORCE_WASI) {
	...
	if (!nativeBinding || process.env.NAPI_RS_FORCE_WASI) {
		try {
			wasiBinding = require('@sprocket/native-wasm32-wasi');
			nativeBinding = wasiBinding;
		} catch (err) {
			if (process.env.NAPI_RS_FORCE_WASI) {
				if (!wasiBindingError) {
