...
fn build_workspace_preamble(
    ...
    [
        ...
        "Prefer `web_search` and `scrape_url` over the browser tools (`browser_interact`, `browser_screenshot`) whenever the information you need is publicly accessible — they are far cheaper and faster. Reserve the browser tools for interactive or session-bound pages such as merchant checkouts.",
        "",
        "",
        "## Skills",
        "",
